import {Button,Typography,Grid,Container,Stack,Menu,TextField,MenuItem,Badge} from '@mui/material';
import '../App.css';
...
export default function Appbar(){
    ...
    return(
        <>
        <Grid sx={{display:'flex',alignItems:'center',backgroundColor:'#3674f0',height:55}}>
