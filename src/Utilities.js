...
const SITE_URL='http://localhost:300'
...
const formatDate=(date)=>{
    ...
    return `${tempDate.getDate().toString().padStart(2,'0')}-${(tempDate.getMonth()+1).toString().padStart(2,'0')}-${tempDate.getFullYear()}`;
}
...
export {API_INVOICES,API_PRODUCTS,API_LOGIN,API_REGISTER,API_AUTH,API_EVENTS,API_CONTACTS,API_CUSTOMERS,API_DAY_PLANNER,API_PERSONAL_DIARY,API_INFO,API_FORGOT_PASSWORD,BASE_URL,SITE_URL,API_ORDERS,convertTimeTo12H,formatDate,formatTime,getChipColor,getTimeBackgroundColor,findTimeDifference,dateOnly,capitalize,updateStatus,formatDuration,getMinutesAndHoursOnly,convertTimeToInt};